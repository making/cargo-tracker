...
class HandlingReportParserTest {
	...
	void shouldThrowErrorOnParsingNullUnloCode(String input) {
		assertThatThrownBy(() -> HandlingReportParser.parseUnLocode(input)).isInstanceOf(IllegalArgumentException.class)
	...
	void shouldThrowErrorOnParsingNullHandlingEventType(String input) {
		assertThatThrownBy(() -> HandlingReportParser.parseEventType(input)).isInstanceOf(NullPointerException.class)
	...
	void shouldThrowErrorOnParsingEmptyHandlingEventType(String input) {
		assertThatThrownBy(() -> HandlingReportParser.parseEventType(input))
			.isInstanceOf(IllegalArgumentException.class)
			.hasMessage(
					" is not a valid handling event type. Valid types are: [LOAD, UNLOAD, RECEIVE, CLAIM, CUSTOMS]");
	}
	...
	void shouldThrowErrorOnParsingInvalidHandlingEventType(String input) {
		assertThatThrownBy(() -> HandlingReportParser.parseEventType(input))
			.isInstanceOf(IllegalArgumentException.class)
			.hasMessage(
					"XXX is not a valid handling event type. Valid types are: [LOAD, UNLOAD, RECEIVE, CLAIM, CUSTOMS]");
	}
	...
	void shouldThrowErrorOnParsingNullDate(String input) {
		assertThatThrownBy(() -> HandlingReportParser.parseDate(input)).isInstanceOf(IllegalArgumentException.class)
