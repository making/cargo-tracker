...
class CargoTest {
	...
	void testConstruction() {
		...
		final RouteSpecification routeSpecification = new RouteSpecification(STOCKHOLM, MELBOURNE, arrivalDeadline);
	...
	void testIsUnloadedAtFinalDestination() {
		...
		events.add(new HandlingEvent(cargo, Instant.ofEpochSecond(20), Instant.now(), HandlingEvent.Type.UNLOAD, TOKYO,
				voyage));
		cargo.deriveDeliveryProgress(new HandlingHistory(events));
		assertThat(cargo.delivery().isUnloadedAtDestination()).isFalse();
	...
	private Cargo populateCargoOffHongKong() throws Exception {
		...
		events.add(new HandlingEvent(cargo, getDate("2007-12-01"), Instant.now(), HandlingEvent.Type.LOAD, STOCKHOLM,
				voyage));
		events.add(new HandlingEvent(cargo, getDate("2007-12-02"), Instant.now(), HandlingEvent.Type.UNLOAD, HAMBURG,
				voyage));

		events.add(new HandlingEvent(cargo, getDate("2007-12-03"), Instant.now(), HandlingEvent.Type.LOAD, HAMBURG,
				voyage));
		events.add(new HandlingEvent(cargo, getDate("2007-12-04"), Instant.now(), HandlingEvent.Type.UNLOAD, HONGKONG,
				voyage));
	...
	private Cargo populateCargoOffMelbourne() throws Exception {
		...
		events.add(new HandlingEvent(cargo, getDate("2007-12-05"), Instant.now(), HandlingEvent.Type.LOAD, HONGKONG,
				voyage));
		events.add(new HandlingEvent(cargo, getDate("2007-12-07"), Instant.now(), HandlingEvent.Type.UNLOAD, MELBOURNE,
				voyage));
	...
	void testIsMisdirected() {
		...
		handlingEvents.add(new HandlingEvent(cargo, Instant.ofEpochSecond(10), Instant.ofEpochSecond(20),
				HandlingEvent.Type.RECEIVE, SHANGHAI));
		...
		handlingEvents
			.add(new HandlingEvent(cargo, Instant.now(), Instant.now(), HandlingEvent.Type.RECEIVE, HANGZHOU));
		events.addAll(handlingEvents);
		cargo.deriveDeliveryProgress(new HandlingHistory(events));
