...
public class HandlingEventService {
	 ...
	 * @throws CannotCreateHandlingEventException if a handling event that represents an
	 * actual event that's relevant to a cargo we're tracking can't be created from the
	 * parameters
	 */
